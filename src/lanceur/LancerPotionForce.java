...
public class LancerPotionForce {
	
	private static String usage = "USAGE : java " + LancerPotionForce.class.getName() + " [ port [ ipArene ] ]";
	...
	public static void main(String[] args) {		
		...
		try {
			logger = new LoggerProjet(true, "potion_invisibilite"+groupe);
		} catch (IOException e) {
			e.printStackTrace();
		...
		try {
			...
			// ajout de la potion
			arene.ajoutePotion(new PotionForce(), Calculs.positionAleatoireArene());
